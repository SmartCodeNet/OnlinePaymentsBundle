...
use GG\OnlinePaymentsBundle\BlueMedia\Hash\ArgsTransport\TransactionRefundResponseArguments;
...
class TransactionRefundResponseMessage extends MessageAbstract
{
    /**
     * @var IntegerNumber
     */
    ...
    {
        $args = new TransactionRefundResponseArguments();
